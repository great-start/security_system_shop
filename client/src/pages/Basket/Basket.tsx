    ...
    return (
        <Card border='light' className={css.basket}>
            ...
            {products && products.map(product => <Card
                ...
                <Button variant={'outline-secondary'} style={{ alignSelf: 'center', marginRight: '10px', border: 'none' }}
                        onClick={(e) => {
                            e.preventDefault();
                ...
                <div style={{ alignSelf: 'center', marginRight: '10px' }}>{productSum[product.id] * product.price} грн.</div>
                ...
                <Button variant='outline-secondary'
                    ...
                    <svg xmlns='http://www.w3.org/2000/svg' width='25' height='25' fill='currentColor' className='bi bi-x-square' viewBox='0 0 16 16'>
                        <path
            ...
            <p style={{ alignSelf: 'end', marginRight: '10px', marginTop: '10px', fontWeight: 'bold' }}>Загальна сумма покупки: {sum} грн.</p>
